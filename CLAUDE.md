...
| ต้องการให้ส่งการ์ดทางไปรษณีย์ | checkbox | — (ไม่ติ๊กได้ ค่าเริ่มต้นไม่ติ๊ก) | **เดิมเป็น radio 3 ตัวเลือก (ส่งไปรษณีย์/รับด้วยมือ/ไม่ต้องส่ง) + มีฟิลด์ "ชื่อที่ต้องการให้ปรากฏบนการ์ด" แยกต่างหาก เจ้าของขอตัดทั้งสองอย่างทิ้งและรวบให้เหลือ checkbox เดียว** ตอนนี้ไม่มีฟิลด์ชื่อ-บนการ์ดแยกแล้ว ใช้ "ชื่อ-นามสกุลของท่าน" ด้านบนแทนตรงๆ (ไม่มีคำนำหน้า/ยศ/ชื่อคู่สมรสแบบเดิมอีกต่อไป — ถ้าจะพิมพ์การ์ดแบบทางการต้องไปเติมเองตอนพิมพ์จริง) ติ๊กแล้วโชว่ที่อยู่/เบอร์โทรด้านล่าง เฉพาะกลุ่มสะดวกร่วมงานเท่านั้น (ไม่สะดวกร่วมงานใช้คำถามคนละอันด้านล่าง) |
| ที่อยู่จัดส่ง | textarea | ✓ เฉพาะสะดวกร่วมงาน **และ** ติ๊กต้องการส่งไปรษณีย์ | ซ่อนเป็นค่าเริ่มต้น (checkbox ไม่ติ๊กมาก่อน) |
| เบอร์โทร | tel | ✓ เฉพาะสะดวกร่วมงาน **และ** ติ๊กต้องการส่งไปรษณีย์ | เหมือนที่อยู่จัดส่ง |
| สะดวกรับการ์ดไว้เป็นที่ระลึกไหม | สะดวกรับการ์ด / ไม่สะดวกรับการ์ด | ✓ ถ้าไม่สะดวกร่วมงาน | เฉพาะกลุ่ม "ไม่สะดวกร่วมงาน" — ใช้คอลัมน์ชีตเดียวกับ "ท่านสะดวกรับการ์ดแบบใด" ด้านบนแต่ค่าตัวเลือกคนละชุด (ดูหมายเหตุคอลัมน์ด้านล่าง) |
| อยากบอกอะไรบ่าวสาวไหม | textarea | — | แสดงเสมอ ไม่ว่าจะมาหรือไม่มา |

คอลัมน์ในชีตเรียงตามนี้ โดยมี `เวลาบันทึก` เป็นคอลัมน์แรก **ไม่มีคอลัมน์ "ชื่อที่ต้องการให้ปรากฏบนการ์ด" แยกแล้ว** (ตัดออกไปพร้อมฟิลด์) — คอลัมน์ **"ท่านสะดวกรับการ์ดแบบใด" ใช้ร่วมกันสองความหมาย ต้องดู `ท่านจะมาร่วมงานหรือไม่` ประกอบเสมอถึงจะตีความถูก**: กลุ่มสะดวกร่วมงานจะเป็น "ส่งไปรษณีย์"/"ไม่ต้องส่งไปรษณีย์" (มาจาก checkbox), กลุ่มไม่สะดวกร่วมงานจะเป็น "สะดวกรับการ์ด"/"ไม่สะดวกรับการ์ด" (คำตอบที่ระลึก) — แถวไม่สะดวกร่วมงานจะมีคอลัมน์ มาด้วยกันกี่ท่าน/ที่อยู่/เบอร์โทร ว่างเสมอ (ตั้งใจ ไม่ใช่บั๊ก)

...
| เป็นแขกฝั่งเจ้าบ่าวหรือเจ้าสาว | dropdown: ฝั่งเจ้าบ่าว / ฝั่งเจ้าสาว | ✓ | แสดงเสมอ ไม่ว่าจะมาหรือไม่มา (เพิ่มทีหลังตามที่เจ้าของขอ) — ตัวเลือกแรกเป็น placeholder ที่เลือกไม่ได้ (`disabled`) บังคับให้เลือกจริง |
...
| มีผู้ติดตามมาด้วยกันกี่ท่าน (นับรวมท่าน) | number 1–10 | ✓ ถ้าสะดวกร่วมงาน | ซ่อนเมื่อ "ไม่สะดวกร่วมงาน" (ดูแถวถัดไป) |
| **ชื่อที่ต้องการให้ปรากฏบนการ์ด** | text | ✓ ถ้าสะดวกร่วมงาน | ฟิลด์สำคัญที่สุด (ของกลุ่มที่มา) ต้องมี placeholder เป็นตัวอย่างชื่อไทยพร้อมคำนำหน้า — ซ่อนเมื่อ "ไม่สะดวกร่วมงาน" |
| ท่านสะดวกรับการ์ดแบบใด | สะดวกร่วมงาน: ส่งไปรษณีย์ / รับด้วยมือ / ไม่ต้องส่ง — ไม่สะดวกร่วมงาน: สะดวกรับการ์ด / ไม่สะดวกรับการ์ด | ✓ ทั้งสองกรณี | **ใช้คอลัมน์เดียวกันแต่ค่าตัวเลือกต่างกันตาม attend** — กลุ่ม "ไม่สะดวกร่วมงาน" ไม่ถามที่อยู่/ชื่อการ์ด (เจ้าของจะฝากญาติส่งหรือไปส่งเอง ไม่อยากรบกวนถามละเอียด) แค่เช็คว่าอยากได้การ์ดเป็นที่ระลึกไหมเฉยๆ |
| ที่อยู่จัดส่ง | textarea | ✓ เฉพาะสะดวกร่วมงาน **และ** เลือกส่งไปรษณีย์ | ซ่อนกรณีอื่นทั้งหมด (รวมถึงกลุ่มไม่สะดวกร่วมงานเสมอ) |
| เบอร์โทร | tel | ✓ เฉพาะสะดวกร่วมงาน **และ** เลือกส่งไปรษณีย์ | เหมือนที่อยู่จัดส่ง |
| อยากบอกอะไรบ่าวสาวไหม | textarea | — | แสดงเสมอ ไม่ว่าจะมาหรือไม่มา |

คอลัมน์ในชีตเรียงตามนี้ โดยมี `เวลาบันทึก` เป็นคอลัมน์แรก — แถวของคนที่ "ไม่สะดวกร่วมงาน" จะมีคอลัมน์ มาด้วยกันกี่ท่าน/ชื่อบนการ์ด ว่างเสมอ, คอลัมน์ "ท่านสะดวกรับการ์ดแบบใด" จะเป็น "สะดวกรับการ์ด"/"ไม่สะดวกรับการ์ด" แทนค่าปกติ, และที่อยู่/เบอร์โทรว่างเสมอ (ตั้งใจ ไม่ใช่บั๊ก — อ่านค่าในคอลัมน์นี้ต้องดู attend ประกอบด้วยว่าเป็นวิธีจัดส่งจริงหรือแค่คำตอบใช่/ไม่ใช่)
